        ...
        :
          <div className="type">
            <div className="type__menu">
            {
              ...
              :
              <>
                <ProductInput className="type__menu-input" value={typeName} placeholder="Enter type" onChange={(e) => setTypeName(e.target.value)} />
                <TypeAdd setName={setTypeName} name={typeName} empty={setEmptyType} />
              </>
            }
          </div>
          <div className="type__info">
            <ul className="type__items">
              {
                types.map(type => <li className="type__item" key={type.id} >{type.name}
