        ...
        <>
          <div className="product">
            <form className="product__menu">
              <ProductInput
                className={styleInput.product__input}
                value={productName}
              ...
              />
              <ProductSelect
                className={styleSelect.product__select}
                value={productType}
                name="type"
                arr={types}
                onChange={(e) => {
            ...
            <div>
              {!emptyValue ? (
                ...
                <div className="product__info-empty">
                  Произошла ошибка!
                  <br />
                  Такой товар уже есть или вы ввели пустое значение
                </div>
              )}
            </div>
            <div>
